 ...
 */
public class QuestionActivityModerado extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quest2List = db.getAllQuestions_MODERADO();  // this will fetch all quetions



        currentQ = quest2List.get(qid_2); // the current question
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionActivityModerado.this, ResultActivity.class);
