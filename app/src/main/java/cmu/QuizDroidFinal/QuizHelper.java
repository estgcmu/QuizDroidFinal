...
public class QuizHelper extends SQLiteOpenHelper {
    ...
    public List<Question> getAllQuestions_MODERADO() {
        ...
        if (cursor.moveToFirst()) do {
            ...
            quest_2.setQUESTION(cursor.getString(1));
            quest_2.setANSWER(cursor.getString(2));
            quest_2.setOPTA(cursor.getString(3));
            quest_2.setOPTB(cursor.getString(4));
            quest_2.setOPTC(cursor.getString(5));
            quest_2.setOPTD(cursor.getString(6));
            quest_2.setODIF(cursor.getString(7));
    ...
    public List<Question> getAllQuestions_DIFICIL() {
        ...
        if (cursor_3.moveToFirst()) do {
            ...
            quest_3.setQUESTION(cursor_3.getString(1));
            quest_3.setANSWER(cursor_3.getString(2));
            quest_3.setOPTA(cursor_3.getString(3));
            quest_3.setOPTB(cursor_3.getString(4));
