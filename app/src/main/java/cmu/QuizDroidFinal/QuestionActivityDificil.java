...
/**
 * Created by Tiago Pinto on 26/01/2017.
 */
public class QuestionActivityDificil extends Activity {


    List<Question> quest3List;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quest3List = db.getAllQuestions_DIFICIL();  // this will fetch all quetions



        currentQ = quest3List.get(qid_3); // the current question
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionActivityDificil.this, ResultActivity.class);
