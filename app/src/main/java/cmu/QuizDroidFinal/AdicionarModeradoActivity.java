...
public class AdicionarModeradoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adicionar_moderado2);
    ...
    public void insert_question_moderado(View view){
        ...
        Intent administracao = new Intent (AdicionarModeradoActivity.this, AdministracaoActivity.class);
